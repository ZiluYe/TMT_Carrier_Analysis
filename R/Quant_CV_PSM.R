...
fwrite(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "SN_Corrected" & Amount == "50pg"],"tables/Fig1de_Fig.S2a.txt")

pdf("figures/CV_PSMs.pdf",width = 10,height = 5)

ggplot(SCH2[Av14SN >= 1 & Booster == "HEY" & Amount == "50pg" & is.na(CV) == FALSE], 
...
ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & AGC == "AGC300%" & Amount == "50pg"], 
...
ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "SN_Corrected" & Amount == "50pg"], 
       aes(x = log2(Av14SN), y = log2(CV))) + 
  geom_point(size = 0.3, color = "skyblue", alpha = 0.3)+
...
ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "SN_Raw" & Amount == "50pg"], 
       aes(x = log2(Av14SN), y = log2(CV))) + 
  geom_point(size = 0.3, color = "skyblue", alpha = 0.3)+
  facet_grid(AGC~Ratio) + 
  geom_hline(yintercept = log2(20), size = 1, linetype = "dashed") + theme_prism() + 
...
ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "Int_Corrected" & Amount == "50pg"], 
       aes(x = log2(Av14SN), y = log2(CV))) + 
  geom_point(size = 0.3, color = "skyblue", alpha = 0.3)+
  facet_grid(AGC~Ratio) + 
  geom_hline(yintercept = log2(20), size = 1, linetype = "dashed") + theme_prism() + 
...
ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "Int_Raw" & Amount == "50pg"], 
       aes(x = log2(Av14SN), y = log2(CV))) + 
  geom_point(size = 0.3, color = "skyblue", alpha = 0.3)+
  facet_grid(AGC~Ratio) + 
  geom_hline(yintercept = log2(20), size = 1, linetype = "dashed") + theme_prism() + 
...
pdf("figures/CV_PSMs_v2.pdf",width = 10,height = 10)

p1 <- ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "SN_Corrected" & Amount == "50pg"], 
...
p2 <- ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "SN_Corrected" & Amount == "50pg"], 
             aes(x = log2(Av14SN), y = log2(CV))) + 
  geom_point(size = 0.3, color = "skyblue", alpha = 0.3)+
  facet_grid(Ratio~AGC) + 
  geom_hline(yintercept = log2(20), size = 1, linetype = "dashed") + theme_prism() + 
...
p3 <- ggplot(SCH2[Av14SN >= 1 & Booster %like% "No|HEY" & Method == "Int_Corrected" & Amount == "50pg"], 
             aes(x = log2(Av14SN), y = log2(CV))) + 
  geom_point(size = 0.3, color = "skyblue", alpha = 0.3)+
  facet_grid(Ratio~AGC) + 
  geom_hline(yintercept = log2(20), size = 1, linetype = "dashed") + theme_prism() + 
